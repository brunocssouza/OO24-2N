...
export class Ataque implements Habilidade{
    ...
    exibirDescricao():void {
        console.log(`Esta é uma habilidade física de tipo ${this.tipo} chamada de ${this.nome} com dano base de ${this.valor} que se baseia em ${this.descricao.toLowerCase()}.`)
    }

    ativar(alvoRecebido:Monstro|Cacador):void {
        console.log(`[✔] A habilidade ${this.nome} foi ativada, causando ${this.calcularDano(alvoRecebido)} de dano físico a ${alvoRecebido.getNome()}!`)
    }
