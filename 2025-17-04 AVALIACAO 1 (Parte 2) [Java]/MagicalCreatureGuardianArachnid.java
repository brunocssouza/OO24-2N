public class MagicalCreatureGuardianArachnid extends MagicalCreatureGuardian {

    MagicalCreatureGuardianArachnid(String name, int hp, String type, String power, int damage, String secret) {
